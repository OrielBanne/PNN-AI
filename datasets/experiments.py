...
def get_experiment_modalities_params(exp_info: ExpInfo, lwir_skip: int, lwir_max_len: int, vir_skip, vir_max_len: int,
                                     color_skip, color_max_len: int = None):
    ...
    if 'color' in exp_info.modalities_norms.keys():
        modalities['color'] = {
            'max_len': color_max_len, 'skip': color_skip, 'transform': T.Compose(
    ...
    modalities.update(
        {  # this is VIR, should be changed
            mod: {
                'max_len': vir_max_len, 'skip': vir_skip, 'transform': T.Compose(
            ...
            # if not changed - other modalities should be added here as well
        }
    )
...
experiments_info: Dict[str, ExpInfo] = {
    ...
    'Exp4': ExpInfo(
        ...
        datetime(2020, 7, 1),
        {  # Normalization according to mean and StdDev
            # TODO : Calculate the values for Exp4
            'lwir': ([21596.1055], [139.9253]),
            '577nm': ([0.0266], [0.0574]),
            '692nm': ([.1453], [.3015]),
            '732nm': ([.1578], [.6006]),
...
plant_positions = {
    'Exp0': ExpPositions({
        ...
        'vir_positions': (
            ...
            (1367, 1419), (1794, 1380), (2162, 1367), (2583, 1346), (3281, 1404), (3654, 1452), (4053, 1431),
            (4449, 1436),
            (1389, 1823), (1793, 1803), (2195, 1767), (2580, 1776), (3294, 1805), (3680, 1802), (4086, 1778),
            (4457, 1803),
            (1397, 2211), (1794, 2199), (2189, 2189), (2639, 2205), (3303, 2201), (3675, 2159), (4064, 2147),
            (4467, 2177),
            (1386, 2582), (1821, 2588), (2219, 2597), (2642, 2607), (3303, 2588), (3665, 2615), (4062, 2574),
            (4463, 2547)
        )
    }),
    'Exp1': ExpPositions({
        ...
        'vir_positions': (
            ...
            (533, 1312), (1053, 1231), (1625, 1425), (2250, 1300), (3152, 1300), (3730, 1265), (4230, 1310),
            (4780, 1255),
            (500, 1765), (1200, 1800), (1716, 1860), (2350, 1786), (3205, 1780), (3725, 1730), (4245, 1690),
            (4720, 1730),
            (696, 2319), (1183, 2302), (1707, 2268), (2360, 2312), (3176, 2266), (3819, 2173), (4299, 2125),
            (4780, 2223),
            (445, 2823), (1200, 1524), (1643, 2406), (2381, 2350), (3137, 2273), (3825, 2186), (4320, 2155),
            (4802, 2228),
            (669, 3342), (1237, 3287), (1769, 3326), (2334, 3338), (3180, 3294), (3762, 3269), (4272, 3249),
            (4855, 3186)
        )
    }),
    'Exp2': ExpPositions({
        ...
        'vir_positions': (
            (581, 629), (1039, 611), (1441, 553), (1925, 503), (2378, 452), (3115, 437), (3643, 410), (4094, 398),
            (4616, 404),
            (586, 1235), (1089, 1172), (1482, 1149), (1927, 1109), (2386, 1102), (3137, 1038), (3656, 1000),
            (4192, 990), (4624, 915),
            (588, 1697), (1039, 1695), (1483, 1697), (1892, 1698), (2415, 1661), (3149, 1568), (3724, 1529),
            (4176, 1491), (4614, 1464),
            (586, 2279), (989, 2234), (1465, 2263), (1947, 2247), (2482, 2174), (3239, 2066), (3692, 2031),
            (4202, 2020), (4665, 1969),
            (626, 2713), (1024, 2690), (1468, 2713), (2014, 2705), (2515, 2697), (3299, 2655), (3838, 2589),
            (4227, 2559), (4685, 2580),
            (626, 3264), (1075, 3225), (1532, 3243), (1968, 3237), (2519, 3235), (3318, 3200), (3811, 3218),
            (4244, 3218), (4709, 3256)
        ),
        'color_positions': (
            (1004, 1091), (1195, 1085), (1409, 1065), (1651, 1041), (1892, 1032), (2255, 1020), (2521, 1005),
            (2758, 1006), (3039, 1000),
            (966, 1390), (1221, 1373), (1435, 1363), (1663, 1334), (1887, 1358), (2268, 1319), (2520, 1311),
            (2788, 1310), (3025, 1270),
            (956, 1633), (1189, 1624), (1418, 1644), (1627, 1645), (1904, 1619), (2265, 1592), (2555, 1569),
            (2808, 1551), (3042, 1538),
            (939, 1943), (1158, 1910), (1395, 1915), (1666, 1920), (1933, 1892), (2308, 1843), (2545, 1825),
            (2807, 1824), (3053, 1796),
            (957, 2153), (1156, 2148), (1397, 2154), (1676, 2147), (1934, 2148), (2343, 2147), (2635, 2124),
            (2841, 2110), (3064, 2115),
            (967, 2364), (1183, 2404), (1421, 2428), (1653, 2431), (1930, 2428), (2358, 2416), (2591, 2434),
            (2815, 2425), (3071, 2504)
        )
    }),
    'Exp3': ExpPositions({
    ...
    'Exp4': ExpPositions({
        'lwir_positions': (
            (32, 328), (120, 68), (198, 230), (280, 140), (362, 320), (442, 62), (514, 64), (598, 62),
            (38, 404), (120, 232), (202, 324), (290, 60), (370, 232), (446, 144), (520, 146), (604, 388),
            (40, 234), (126, 330), (206, 64), (292, 322), (370, 480), (450, 478), (524, 388), (606, 232),
            (42, 74), (130, 146), (210, 146), (292, 396), (372, 60), (456, 390), (530, 228), (606, 312),
            (42, 152), (130, 410), (222, 402), (296, 230), (372, 392), (462, 316), (530, 474), (608, 466),
            (48, 478), (142, 484), (226, 482), (296, 484), (378, 136), (464, 228), (536, 308), (610, 148)
        ),
        'vir_positions': (
            (452, 2338), (1076, 398), (1686, 1582), (2264, 912), (2896, 2204), (3454, 306), (4012, 276), (4664, 254),
            (488, 1004), (1094, 1608), (1706, 354), (2326, 328), (2914, 326), (3482, 906), (4054, 906), (4718, 1502),
            (496, 418), (1150, 2318), (1728, 2272), (2376, 2234), (2934, 1568), (3586, 3368), (4118, 1494),
            (4722, 2116),
            (498, 1656), (1166, 984), (1760, 972), (2396, 1568), (2984, 2736), (3598, 2724), (4126, 2706), (4736, 898),
            (510, 2926), (1200, 2932), (1882, 2826), (2396, 2790), (2986, 866), (3624, 1524), (4186, 2118),
            (4766, 2702),
            (554, 3492), (1298, 3476), (1922, 3446), (2448, 3438), (2994, 3418), (3628, 2170), (4186, 3336),
            (4808, 3288)
        ),
        'color_positions': (
            (872, 1968), (1218, 980), (1522, 1590), (1822, 1256), (2124, 1914), (2424, 958), (2714, 942), (3052, 930),
            (888, 2262), (1222, 1600), (1538, 968), (1854, 960), (2150, 1592), (2430, 1266), (2718, 1268), (3060, 1570),
            (902, 2562), (1242, 1960), (1540, 1934), (1864, 1922), (2154, 962), (2468, 2516), (2748, 2180),
            (3064, 1882),
            (904, 1278), (1258, 2270), (1566, 1282), (1868, 2204), (2164, 2180), (2478, 2182), (2756, 1570),
            (3076, 1264),
            (912, 976), (1264, 1276), (1610, 2218), (1880, 1592), (2168, 2534), (2494, 1902), (2780, 2510),
            (3080, 2190),
            (912, 1614), (1296, 2552), (1616, 2540), (1886, 2538), (2182, 1242), (2496, 1576), (2784, 1880),
            (3098, 2490)
        ),
    })
}

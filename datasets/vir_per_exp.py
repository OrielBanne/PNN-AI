...
# plants are indexed left to right, top to bottom - Exp1
Exp1_positions = [

]

img_size_Exp1 = (5472, 3648)

# plants are indexed left to right, top to bottom - Exp2
Exp2_positions = [

]

img_size_Exp2 = (5472, 3648)

# plants are indexed left to right, top to bottom - Exp3
Exp3_positions = [
	(837, 679), (863, 1329), (873, 1943), (887, 2557), (899, 3093), 
	(1619, 615), (1611, 1319), (1707, 1961), (1727, 2533), (1773, 3025), 
	(2363, 593), (2429, 1313), (2473, 1933), (2489, 2555), (2591, 3093), 
	(3067, 601), (3153, 1313), (3161, 1971), (3235, 2519), (3249, 3081), 
	(3787, 601), (3791, 1307), (3825, 1949), (3805, 2461), (3861, 3019),
	(4399, 565), (4443, 1299), (4465, 1981), (4509, 2481), (4521, 3021)

]

img_size_Exp3 = (5472, 3648)



## here choose positions and dates to correct experiment
positions = Exp0_positions

## define datetime per experiment:

Exp0_dates = [(2019, 6,  4),(2019, 7, 7)]
...
class VIR(data.Dataset):
	...
	these are the dates from the folder
	'Exp0':
        datetime(2019, 6, 5),
        datetime(2019, 6, 19)
		
	these are the dates from the original vir file:
	'Exp0':
        datetime(2019, 6, 4),
        datetime(2019, 7, 7)	
